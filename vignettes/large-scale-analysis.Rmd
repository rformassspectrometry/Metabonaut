...
the code locally about 800GB or free disk space is required.

**Note**: the *xcms* version used for this document is currently available in
the *large_scale_data* branch. It can be installed using
`remotes::install_github("sneumann/xcms", ref = "large_scale_data")`.
...
metabolomics data set with about 4,000 data files is analyzed and *xcms*' memory
usage and performance tracked. Performance and memory usage for different
configurations are compared on a smaller data subset. Finally, details on the
internal data and memory handling of *xcms* are presented and properties of
different configurations for efficient (and parallel) processing of large scale
data are discussed.
...
`Spectra` backend from the *[MsBackendSql](https://bioconductor.org/packages/3.20/MsBackendSql)* package (see the last
...
#> 1 tmp<-peaksData(spectra(tsub[1:8]))             6.17             1922.9
#>   Peak_RAM_Used_MiB
#> 1            3865.1
```
...
|:------------------:|:----:|:--------------:|:---------------------:|
|   XcmsExperiment   |  1   |      6843      |         38.19         |
|   XcmsExperiment   |  2   |      6779      |         22.39         |
|   XcmsExperiment   |  4   |      6779      |          14           |
|   XcmsExperiment   |  8   |      6779      |         11.43         |
| XcmsExperimentHdf5 |  1   |      6837      |         38.24         |
| XcmsExperimentHdf5 |  2   |      6837      |         22.28         |
| XcmsExperimentHdf5 |  4   |      6837      |         14.04         |
| XcmsExperimentHdf5 |  8   |      6837      |         11.8          |
...
|   Result object    | CPUs | Peak RAM [MiB] | Processing time [min] |
|:------------------:|:----:|:--------------:|:---------------------:|
|   XcmsExperiment   |  1   |      6837      |         6.841         |
|   XcmsExperiment   |  2   |      6786      |         5.43          |
|   XcmsExperiment   |  4   |      6786      |         4.407         |
|   XcmsExperiment   |  8   |      6786      |         4.34          |
| XcmsExperimentHdf5 |  1   |      6786      |         6.936         |
| XcmsExperimentHdf5 |  2   |      6786      |         5.486         |
| XcmsExperimentHdf5 |  4   |      6786      |         4.475         |
| XcmsExperimentHdf5 |  8   |      6786      |         4.513         |
...
|:------------------:|:----:|:--------------:|:---------------------:|
|   XcmsExperiment   |  1   |      4854      |         26.37         |
| XcmsExperimentHdf5 |  1   |      4625      |         26.98         |
...
#> Warning in `[<-.data.frame`(`*tmp*`, , diffcn, value = list(merged = NA)):
...
|   Result object    | CPUs | Peak RAM [MiB] | Processing time [min] |
|:------------------:|:----:|:--------------:|:---------------------:|
|   XcmsExperiment   |  1   |      6787      |         6.448         |
|   XcmsExperiment   |  2   |      6761      |         2.426         |
|   XcmsExperiment   |  4   |      6761      |         2.507         |
|   XcmsExperiment   |  8   |      6761      |         2.583         |
| XcmsExperimentHdf5 |  1   |      6761      |         6.578         |
| XcmsExperimentHdf5 |  2   |      6761      |         5.423         |
| XcmsExperimentHdf5 |  4   |      6761      |         4.394         |
| XcmsExperimentHdf5 |  8   |      6761      |         4.323         |
...
- For the present analysis, a big part of computation time was spent on the
  ...
  *[MsbackendSql](https://bioconductor.org/packages/3.20/MsbackendSql)* for details. The code that could be used to store
...
#>  [41] GenomicRanges_1.58.0        iterators_1.0.14
#>  [43] Rcpp_1.0.14                 SummarizedExperiment_1.36.0
#>  [45] knitr_1.50                  IRanges_2.40.1
#>  [47] Matrix_1.7-3                igraph_2.1.4
#>  [49] tidyselect_1.2.1            abind_1.4-8
#>  [51] yaml_2.3.10                 doParallel_1.0.17
#>  [53] affy_1.84.0                 codetools_0.2-20
#>  [55] curl_6.2.2                  lattice_0.22-6
