...
![Base peak chromatogram of the full data set.](figures/large-scale-bpc-1.png)
...
![EIC plots for 3 compounds in 200 randomly selected samples.](figures/large-scale-eic-random-1.png)
...
![EIC plots for 3 compounds in 200 randomly selected samples with identified
chromatographic peaks highlighted (grey color).](figures/large-scale-eic-random-cp-1.png)
...
![EIC plots for 3 compounds in 5 samples. Detected chromatographic peaks are
indicated with a grey color.](figures/large-scale-eic-random-cp-5-1.png)
...
![Example EICs after alignment.](figures/large-scale-eic-random-align-1.png)
...
![Evaluation of correspondence settings on compound 1.](figures/large-scale-feature-1-1.png)
...
![Evaluation of correspondence settings on compound 2.](figures/large-scale-feature-2-1.png)
...
![Evaluation of correspondence settings on compound 3.](figures/large-scale-feature-3-1.png)
...
![Comparison of computation time depending on the number of CPUs employed for
the 2 different xcms result storage modes.](figures/large-scale-performance-1.png)
