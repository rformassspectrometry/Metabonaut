...
``` r
kc <- read_xlsx("known_compounds_largescale.xlsx") |>
    as.data.frame()
rownames(kc) <- kc$name
kc$rtmin <- kc$rt - 20
kc$rtmax <- kc$rt + 20
...
|      &nbsp;      |     name     |  rt   |  mz   | rtmin | rtmax | mzmin | mzmax |
|:----------------:|:------------:|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
| **LysoPC_18∶1**  | LysoPC_18∶1  | 382.2 | 522.4 | 362.2 | 402.2 | 522.3 | 522.4 |
| ** LysoPC_18∶2** |  LysoPC_18∶2 | 347.3 | 520.3 | 327.3 | 367.3 | 520.3 | 520.4 |
|   **MG_18∶2**    |   MG_18∶2    |  384  | 337.3 |  364  |  404  | 337.3 | 337.3 |
