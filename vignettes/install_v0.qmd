...
`@sha256:<digest>` ensures that a specific archived image is loaded from
Dockerhub. Docker images for upcoming versions releases will be made available
using a different tag (e.g. v1.6.3) hence images from older versions will also
