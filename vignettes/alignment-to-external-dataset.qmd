---
title: "Seamless Alignment: Merging New Data with an Existing Preprocessed Dataset"
...
vignette: >
  %\VignetteIndexEntry{Seamless Alignment: Merging New Data with an Existing Preprocessed Dataset}
...
preprocessed LC-MS dataset using the *xcms* package [@louail_xcms_2025].
