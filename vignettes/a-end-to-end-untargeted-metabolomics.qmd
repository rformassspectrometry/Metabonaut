...
plot and evaluate all the ions after each steps.
...
recording of the retention time of thepure standard for a compound on the same
LC setup. An alternative approach which might provide better inside on
...
presenting how to process and annotate it using python tools [here](https://rformassspectrometry.github.io/Metabonaut/articles/SpectriPy_tutorial_metabonaut.html).
