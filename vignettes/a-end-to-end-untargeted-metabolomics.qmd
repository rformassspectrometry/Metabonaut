...
There are `r length(sampleData(lcms1))` samples in this data set. Below are
...
restricted, *m/z* range and a selected retention time window, EICs are
...
defined.
The primary objective of preprocessing is the quantification of
signals from ions measured in a sample, addressing any potential retention time
drifts between samples, and ensuring alignment of quantified signals across
samples within an experiment. The final result of LC-MS data preprocessing is a
numeric matrix with abundances of quantified entities in the samples of the
experiment.
...
the EIC needs to be sufficiently wide. 
If the function fails to find a peak in an EIC, the initial troubleshooting
...
indicates that our custom settings are suitable for our dataset. We
now proceed and apply them to the entire dataset, extracting EICs again for the
same ions to evaluate and confirm that chromatographic peak detection worked as
expected. Note:
...
```{r, message=FALSE}
#| fig-cap: "Figure 25. Correspondence analysis results, Methionine."
#| fig-align: center
#| code-fold: true
...
```{r, message=FALSE}
#| fig-cap: "Figure 26. Examples of chromatographic peaks with missing values."
#| code-fold: true
#| code-summary: "Show the code"
...
#| fig-cap: "Figure 27. Examples of chromatographic peaks with missing values after gap-filling."
#| code-fold: true
#| code-summary: "Show the code"
...
#| fig-cap: "Figure 28. Detected vs. filled-in signal."
#| code-fold: true
#| code-summary: "Show the code"
...
#lcms1 <- readMsObject(XcmsExperiment(), AlabasterParam(path = file.path("objects/preprocessed_lcms1")))
...
#| fig-cap: "Figure 28. PCA of the data coloured by phenotypes."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r counts1}
#| fig-cap: "Figure 29. Number of detected peaks and feature abundances."
#| code-fold: true
#| code-summary: "Show the code"
...
#| fig-cap: "Figure 30. RLA plot for the raw data and filled data."
#| code-fold: true
#| code-summary: "Show the code"
...
#| fig-cap: "Figure 31. PC1 and PC2 of the data before and after normalization."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r, fig.height=8, fig.width=6}
#| fig-cap: "Figure 32. PC3 and PC4 of the data before and after normalization."
#| code-fold: true
#| code-summary: "Show the code"
pca_raw <- autoplot(pca_res, data = vals_st ,
...
#| fig-cap: "Figure 33. RLA plot before and after normalization."
#| code-fold: true
#| code-summary: "Show the code"
...
Before performing complex statistical analysis we can evaluate the data

A possible evaluation is to which features are overlapping between the
different samples.

```{r eval=FALSE, include=FALSE}
#age group
low <- res$age < 40
middle <- res$age > 40 & res$age < 60
high <- res$age > 60
...
```{r}
#| fig-cap: "Figure 34. PCA of the data after normalization and quality control."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r}
#| fig-cap: "Figure 35. PCA colored by age of the data after normalization and quality control."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r histogram}
#| fig-cap: "Figure 36. Distribution of raw (left) and adjusted p-values (right)."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r volcano}
#| fig-cap: "Figure 37. Volcano plot showing the analysis results."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r}
#| fig-cap: "Figure 38. Extracted ion chromatograms of the significant features."
...
#| fig-cap: "Figure 39. Extracted ion chromatograms and MS2 spectra for the annotated feature."
#| code-fold: true
#| code-summary: "Show the code"
col_sample <- col_phenotype[sampleData(lcms1)$phenotype]
...
```{r}
#| fig-cap: "Figure 40. MS2 spectra for the annotated feature."
#| code-fold: true
#| code-summary: "Show the code"
