...
```{r bpc1, echo=TRUE}
#| fig-cap: "Figure 5. BPC of all samples colored by phenotype."
...
```{r heatmap1}
#| fig-cap: "Figure 7. Heatmap of TIC similarities."
...
set of 15 IS was spiked to all samples. After reviewing signal of all of them,
we selected two to guide this analysis process. However, we also advise to plot
and evaluate all the ions after each steps.
...
#| tbl-cap: "Table 4. Internal standard list with respective m/z and expected retention time [s]."
#| tbl-style: "font-size: 0.8em"
...
```{r}
#| fig-cap: "Figure 9. EIC of cystine and methionine."
#| fig-align: center
#| code-fold: true
#| code-summary: "Show the code"
...
extracted ion chromatogram for cystine and methionine ions and evaluate its
results.
...
```{r}
#| fig-cap: "Figure 11. Chromatographic peak detection on EICs."
#| fig-align: center
#| code-fold: true
#| code-summary: "Show the code"
...
indicates that our custom settings seem thus to be suitable for our dataset. We
...
-   Parameter `chunkSize` of `findChromPeaks()` defines the number of data
    ...
    of the chromatographic peak detection step.

```{r run-find-chrompeak-on-entire-dataset}
#' Using the same settings, but with default snthresh
param <- CentWaveParam(peakwidth = c(1, 8), ppm = 15, integrate = 2)
lcms1 <- findChromPeaks(lcms1, param = param, chunkSize = 5)
...
#| fig-cap: "Figure 12. Chromatographic peak detection on EICs after processing."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r}
#| fig-cap: "Figure 13. Examples of CentWave peak detection artifacts."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r test-merging}
#| fig-cap: "Figure 14. Examples of CentWave peak detection artifacts after merging."
...
```{r}
#| tbl-cap: "Table 5. Samples and number of identified chromatographic peaks."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r}
#| fig-cap: "Figure 15. BPC of QC samples."
#| fig-align: center
#| code-fold: true
#| code-summary: "Show the code"
#' Get QC samples
...
```{r}
#| fig-cap: "Figure 16. Initial correspondence analysis."
...
```{r}
#| fig-cap: "Figure 17. Retention time alignment results."
...
#| fig-cap: "Figure 18. BPC before and after alignment."
#| fig-align: center
#| code-fold: true
#| code-summary: "Show the code"
...
We can now evaluate the alignment effect in our test ions. We will plot the
EICs before and after alignment for both the isotope labeled cystine and
methionine.

```{r specific-ion-before-and-after1}
#| fig-cap: "Figure 19. EICs of cystine and methionine before and after alignment."
#| fig-align: center
#| code-fold: true
#| code-summary: "Show the code"
...
```{r}
#| fig-cap: "Figure 20. Retention time variation of internal standards before and after alignment."
...
```{r}
#| fig-cap: "Figure 21. Initial correspondence analysis, Cystine."
#| code-fold: true
#| code-summary: "Show the code"
plotChromPeakDensity(
    eic_cystine, param = param,
...
```{r}
#| fig-cap: "Figure 22. Initial correspondence analysis, Methionine."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r}
#| fig-cap: "Figure 23. Correspondence analysis with optimized parameters, Cystine."
#| code-fold: true
#| code-summary: "Show the code"
#' Updating parameters
...
```{r}
#| fig-cap: "Figure 24. Correspondence analysis with optimized parameters, Methionine."
#| code-fold: true
#| code-summary: "Show the code"
plotChromPeakDensity(eic_met, param = param,
    col = paste0(col_sample, "80"),
