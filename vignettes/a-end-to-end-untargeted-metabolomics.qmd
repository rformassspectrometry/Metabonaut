...
author: "Philippine Louail, Anna Tagliaferri, Vinicius Verri Hernandes, Daniel Marques de Sá e Silva, Johannes Rainer"
format: html
...
![Figure 1. Steps of the end-to-end workflow and possible
...
```{r phenodata}
#| tbl-cap: "Table 1. Samples from the data set."
...
```{r bpc1, echo=TRUE}
#| fig-cap: "Figure 2. BPC of all samples colored by phenotype."
...
```{r bpc2, echo=TRUE}
#| fig-cap: "Figure 3. BPC after filtering retention time."
#| code-fold: true
...
```{r heatmap1}
#| fig-cap: "Figure 4. Heatmap of TIC similarities."
...
#| tbl-cap: "Table 3. Internal standard list with respective m/z and expected retention time [s]."
...
```{r}
#| fig-cap: "Figure 5. EIC of cystine and methionine."
#| fig-align: center
#| code-fold: true
#| code-summary: "Show the code"
...
employ the `findChromPeaks()` function within *xcms* [@louail_xcms_2025]. This
function supports various algorithms for peak detection, which can be selected
and configured with their respective parameter objects.
...
cystine and methionine ions and evaluate the results.
...
```{r}
#| fig-cap: "Figure 6. Chromatographic peak detection on EICs."
#| fig-align: center
#| code-fold: true
#| code-summary: "Show the code"
...
-   We revert the value for parameter `snthresh` to its default, because, as
    mentioned above, background noise estimation is more reliable when
...
#| fig-cap: "Figure 7. Chromatographic peak detection on EICs after processing."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r, message=FALSE}
#| fig-cap: "Figure 8. Examples of CentWave peak detection artifacts."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r test-merging}
#| fig-cap: "Figure 9. Examples of CentWave peak detection artifacts after merging."
...
```{r}
#| tbl-cap: "Table 4. Samples and number of identified chromatographic peaks."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r}
#| fig-cap: "Figure 10. BPC of QC samples."
#| fig-align: center
#| code-fold: true
#| code-summary: "Show the code"
#' Get QC samples
...
method [@louail_xcms_2025] that performs the alignment by minimizing differences
...
[@louail_xcms_2025] that groups chromatographic peaks with similar *m/z* and
...
```{r}
#| fig-cap: "Figure 11. Initial correspondence analysis."
...
```{r}
#| fig-cap: "Figure 12. Retention time alignment results."
...
#| fig-cap: "Figure 13. BPC before and after alignment."
#| fig-align: center
#| code-fold: true
#| code-summary: "Show the code"
...
#| fig-cap: "Figure 14. EICs of cystine and methionine before and after alignment."
#| fig-align: center
#| code-fold: true
#| code-summary: "Show the code"
...
```{r}
#| fig-cap: "Figure 15. Retention time variation of internal standards before and after alignment."
...
```{r}
#| fig-cap: "Figure 16. Initial correspondence analysis, Cystine."
#| code-fold: true
#| code-summary: "Show the code"
plotChromPeakDensity(
    eic_cystine, param = param,
...
```{r}
#| fig-cap: "Figure 17. Initial correspondence analysis, Methionine."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r}
#| fig-cap: "Figure 18. Correspondence analysis with optimized parameters, Cystine."
#| code-fold: true
#| code-summary: "Show the code"
#' Updating parameters
...
```{r}
#| fig-cap: "Figure 19. Correspondence analysis with optimized parameters, Methionine."
#| code-fold: true
#| code-summary: "Show the code"
plotChromPeakDensity(eic_met, param = param,
    col = paste0(col_sample, "80"),
...
```{r, message=FALSE}
#| fig-cap: "Figure 20. Correspondence analysis results, Methionine."
#| fig-align: center
#| code-fold: true
#| code-summary: "Show the code"
...
```{r}
#| tbl-cap: "Table 5. Distribution of features along the retention time axis."
...
```{r, message=FALSE}
#| fig-cap: "Figure 21. Examples of chromatographic peaks with missing values."
#| code-fold: true
#| code-summary: "Show the code"
...
#| fig-cap: "Figure 22. Examples of chromatographic peaks with missing values after gap-filling."
#| code-fold: true
#| code-summary: "Show the code"
...
#| fig-cap: "Figure 23. Detected vs. filled-in signal."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r unsupervised-checks1, fig.height=8, fig.width=6}
#| fig-cap: "Figure 24. PCA of the data coloured by phenotypes."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r counts1}
#| fig-cap: "Figure 25. Number of detected peaks and feature abundances."
#| code-fold: true
#| code-summary: "Show the code"
...
#| fig-cap: "Figure 26. RLA plot for the raw data and filled data."
#| code-fold: true
#| code-summary: "Show the code"
...
#| fig-cap: "Figure 27. PC1 and PC2 of the data before and after normalization."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r, fig.height=8, fig.width=6}
#| fig-cap: "Figure 28. PC3 and PC4 of the data before and after normalization."
#| code-fold: true
#| code-summary: "Show the code"
pca_raw <- autoplot(pca_res, data = vals_st ,
...
#| fig-cap: "Figure 29. RLA plot before and after normalization."
#| code-fold: true
#| code-summary: "Show the code"
...
#| tbl-cap: "Table 6. Distribution of CV values across samples for the raw and normalized data."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r}
#| fig-cap: "Figure 30. PCA of the data after normalization and quality control."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r}
#| fig-cap: "Figure 31. PCA colored by age of the data after normalization and quality control."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r histogram}
#| fig-cap: "Figure 32. Distribution of raw (left) and adjusted p-values (right)."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r volcano}
#| fig-cap: "Figure 33. Volcano plot showing the analysis results."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r result-table}
#| tbl-cap: "Table 7. Features with significant differences in abundances."
#| code-fold: true
#| code-summary: "Show the code"
...
```{r}
#| fig-cap: "Figure 34. Extracted ion chromatograms of the significant features."
...
```{r}
#| tbl-cap: "Table 8. MassBank database extract."
...
```{r}
#| tbl-cap: "Table 9. MS1 annotation results."
...
number of MS1 and MS2 spectra for each of the files.
...
#| fig-cap: "Figure 35. Precursor ions in the LC-MS/MS data set."
...
#| fig-cap: "Figure 36. Extracted ion chromatograms and MS2 spectra for the annotated feature."
#| code-fold: true
#| code-summary: "Show the code"
col_sample <- col_phenotype[sampleData(lcms1)$phenotype]
...
```{r}
#| fig-cap: "Figure 37. MS2 spectra for the annotated feature."
#| code-fold: true
#| code-summary: "Show the code"
